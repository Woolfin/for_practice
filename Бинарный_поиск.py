...
Доверяй, но проверяй. Вместо списка с числами передайте в функцию find_element() отсортированный по возрастанию список, в котором хранятся строки, например такой:

['алгоритмы', 'будут', 'главным', 'доводом', 'профессионального', 'разработчика'] 
В качестве аргумента element передайте какую-нибудь строку и выполните код: поиск должен работать корректно.
"""